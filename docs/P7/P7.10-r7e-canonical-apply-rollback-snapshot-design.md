...
| **r8c–r8i** | Persistence + Apply/Rollback impl | **yes** (first MR write at r8d smoke) | **NEXT (CONTROLLED)** |

```text
r7d–r7j [DONE] → r9e3h [PASS] → r8a [PASS] → r8b [DESIGN PASS] → r8c [NEXT]
```
...
| **NEXT** | **P7.10-r8c** — snapshot persistence dev/staging |
