...
| [P7.10-r8b](./P7.10-r8b-rollback-snapshot-migration-design.md) migration design | **`PASS_R8B_ROLLBACK_SNAPSHOT_MIGRATION_DESIGN`** — table `p76_canonical_apply_rollback_snapshot` |
...
**Option B** as the implementation target — **designed** in [P7.10-r8b](./P7.10-r8b-rollback-snapshot-migration-design.md). r7e / r8b **do not** create migration files or run Prisma.
...
| **r8b** | [Snapshot migration design](./P7.10-r8b-rollback-snapshot-migration-design.md) | **no** | **DONE** |
| **r8c** | [Snapshot persistence](./P7.10-r8c-rollback-snapshot-persistence-implementation-closeout.md) | **no** (snapshot table only) | **DONE** |
| **r8d–r8i** | Apply/Rollback impl | **yes** (first MR write at r8d smoke) | **NEXT (CONTROLLED)** |

```text
r7d–r7j [DONE] → r9e3h [PASS] → r8a–r8c1 [DONE] → r8d [NEXT]
```

**r7d–r7i do not:** execute Apply · execute rollback · mint tokens in DB · promote `MatchResult`. **r7i** = read-only UI only.

## 14. 下一步

| Priority | Milestone |
|----------|-----------|
| **DONE** | **P7.10-r7i** — [read-only Admin apply review UI](./P7.10-r7i-admin-apply-review-ui-readonly-implementation-closeout.md) |
| **DONE** | **P7.10-r8b** — [migration design](./P7.10-r8b-rollback-snapshot-migration-design.md) |
| **DONE** | **P7.10-r8c** — [snapshot persistence](./P7.10-r8c-rollback-snapshot-persistence-implementation-closeout.md) |
