...
| [P7.10-r7b](./P7.10-r7b-admin-apply-canonical-write-design.md) / [r7c](./P7.10-r7c-admin-apply-canonical-promotion-api-design.md) | Apply UX + promotion API design — **not implemented** |
