...
export type InteractionSimulationLiteChatResult =
...
@Injectable()
export class InteractionSimulationLiteChatCompletionsClient {
  constructor(private readonly aiConfig: InteractionSimulationLiteConfigService) {}

  async complete(
    system: string,
    user: string,
  ): Promise<InteractionSimulationLiteChatResult> {
