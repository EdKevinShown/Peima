...
export type MatchReviewAiChatResult =
  | { ok: true; content: string }
  | {
      ok: false;
      kind: MatchReviewAiChatFailureKind;
      status?: number;
      detail?: string;
    };

@Injectable()
export class MatchReviewAiChatCompletionsClient {
  constructor(private readonly aiConfig: MatchReviewAiConfigService) {}

  async complete(
    system: string,
    user: string,
  ): Promise<MatchReviewAiChatResult> {
