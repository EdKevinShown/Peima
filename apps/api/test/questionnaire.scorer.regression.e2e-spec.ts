...
describe("questionnaire.scorer regression (G-q25 / draft / q06-5E)", () => {
  ...
  it("G-q25-only", () => {
    ...
    expect(out.confidence).toBe(1 / 13);
  ...
  /** G-draft-only-q01to12：q13+ 仍为 draft；本用例仅答 canonical 的 q01+q06 */
  it("G-draft-only-q01to12", () => {
    ...
    expect(out.confidence).toBe(2 / 13);
    expectAllNullExcept(out, {
  ...
  /** G-draft-plus-q25：q01 与 q25 一并参与聚合（confidence 分母=13） */
  it("G-draft-plus-q25", () => {
